...
with pestaña6:
    ...
    st.write("Texto sobre el equipo")
    
    st.image("https://previews.123rf.com/images/mrswilkins/mrswilkins1705/mrswilkins170500004/80934391-ilustraci%C3%B3n-de-imagen-de-perfil-mujer-vector.jpg", caption="Nombre 1", use_column_width=True)
    st.image("https://previews.123rf.com/images/mrswilkins/mrswilkins1705/mrswilkins170500004/80934391-ilustraci%C3%B3n-de-imagen-de-perfil-mujer-vector.jpg", caption="Nombre 2", use_column_width=True)
    st.image("https://previews.123rf.com/images/mrswilkins/mrswilkins1705/mrswilkins170500004/80934391-ilustraci%C3%B3n-de-imagen-de-perfil-mujer-vector.jpg", caption="Nombre 3", use_column_width=True)
    st.image("https://previews.123rf.com/images/mrswilkins/mrswilkins1705/mrswilkins170500004/80934391-ilustraci%C3%B3n-de-imagen-de-perfil-mujer-vector.jpg", caption="Nombre 4", use_column_width=True)
    st.image("https://previews.123rf.com/images/mrswilkins/mrswilkins1705/mrswilkins170500004/80934391-ilustraci%C3%B3n-de-imagen-de-perfil-mujer-vector.jpg", caption="Nombre 5", use_column_width=True)
